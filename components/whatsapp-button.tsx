...
export default function WhatsAppButton() {
  const handleWhatsAppClick = () => {
    window.open("https://wa.me/255678389075", "_blank")
  }
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 animate-float">
      <button
        ...
        className="bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg transition-transform duration-300 hover:scale-110 group"
